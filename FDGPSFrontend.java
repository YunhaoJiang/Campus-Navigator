 ...
 * @author Danny J
 */
public class FDGPSFrontend extends Application implements IGPSFrontend {

  public boolean selectMode;
  public boolean insertMode;
  public String newPlaceName;
  public static IGPSBackend backend;
...
*/
  ...
  public void start(Stage stage) {
    ...
    FDGPSBackend GPSBackend = new FDGPSBackend(); //new Backend();
